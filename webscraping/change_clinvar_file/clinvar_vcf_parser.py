...
# a few adjustments to run the code with ....
...
def clinvar_parser(location_clinvar_file):
    """ Parses the ClinVar file and write it to a new file.

    Args:
        location_clinvar_file: Full location of the ClinVar file.
    """
    warnings.filterwarnings("ignore")
    warnings.simplefilter(action="ignore", category=FutureWarning)
    fd = read_file(location_clinvar_file)
